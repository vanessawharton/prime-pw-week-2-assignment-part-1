...
// if the value of `pets` is greater than the value of `allowedPets`.console.log('js');
if( pets < allowedPets){
...
console.log("I figured out Stretch Goal 18 and it came up with " + ((adventurous === true) ? 'Adventures are great!' : 'How about we stay home?'));